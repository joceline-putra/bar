                                            ...
                                            <form id="form-master" name="form-master" method="" action="">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-ld-12 col-md-12 padding-remove-side">
                                                        <div class="col-lg-4 col-md-4 col-xs-4 padding-remove-left prs-0">
                                                            <div class="form-group">
                                                                <label class="form-label">Identitas</label>
                                                                <select id="identity_type" name="identity_type" class="form-control" readonly>
                                                        ...
                                                        <div class="col-md-8 col-xs-8 col-sm-8 padding-remove-side prl-2">
                                                            <div class="form-group">
                                                                <label class="form-label">Nomor Identitas KTP *</label>
                                                                <input id="identity_number" name="identity_number" type="number" value="" class="form-control" readonly='true'/>
                                                            </div>                          
                                                        </div>             
                                                    </div>                                                     
                                                    <!--
                                                    ...
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side"> 
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 padding-remove-side prl-2">
                                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                        ...
                                                        <div class="checkbox check-success">
                                                            <input id="checkbox_karyawan" type="checkbox" value="3"><label for="checkbox_karyawan">&nbsp;<?php echo $title; ?></label>
                                                        </div>                                                                                                                
                                                    </div>
                                                </div>                        
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="padding-top:8px;">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12 form-group prl-2 prr-2">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo base_url('upload/template/template_karyawan.png');?>" class="img-responsive" style="width:100%;">
                                        </div>               
                                    </div>                                 
                                </div> 
                                <div class="col-md-12 col-sm-12 col-xs-12">                                                 
                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                        <div class="form-group">
                                            ...
                                            <p>Template excel dapat diunduh <a href="<?php echo base_url('upload/template/template_karyawan.xlsx');?>">disini</a>
                                        </div>
                                    </div>              
                                </div>                                   
                            </div>
