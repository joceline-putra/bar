                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0"> 
                                            <form id="form-master" name="form-master" method="" action="">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 padding-remove-side">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-ld-12 col-md-12 padding-remove-side">
                                                        ...
                                                        <div class="col-md-8 col-xs-8 col-sm-8 col-xs-8 padding-remove-side">
                                                            <div class="form-group">
                                                    ...
                                                    -->     
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side"> 
                                                        <div class="col-md-6 col-lg-6 col-xs-6 col-sm-6 padding-remove-left prs-0">
                                                            <div class="form-group">
                                                                <label class="form-label">Telepon *</label>
                                                                <input id="telepon_1" name="telepon_1" type="text" value="" class="form-control" readonly='true'/>
                                                            </div>                          
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 col-xs-6 col-sm-6 padding-remove-side prs-0 prl-2">
                                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                        <div class="col-md-6 col-xs-6 col-sm-6 padding-remove-left">
                                                            <div class="form-group">
                                                                <label class="form-label">Aturan Termin (Pembelian)</label>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-6 padding-remove-side">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="contact_payable_limit" name="contact_payable_limit" type="text" value="" class="form-control" readonly='true'/>
                                                            </div>
                                                        </div>    
                                                    </div>                        
                                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                        ...
                                                        <div class="checkbox check-success">
                                                            <input id="checkbox_supplier" type="checkbox" value="1"><label for="checkbox_supplier">&nbsp;<?php echo $title; ?></label>
                                                        </div>
                                                        <div class="checkbox check-success">
                                                            <input id="checkbox_customer" type="checkbox" value="2"><label for="checkbox_customer">&nbsp;Customer</label>
                                                        </div>
                                                        <div class="checkbox check-success">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo base_url('upload/template/template_supplier.png');?>" class="img-responsive" style="width:100%;">
                                        </div>               
                                    </div>                                 
                                </div> 
                                <div class="col-md-12 col-sm-12 col-xs-12">                                                 
                                    <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                        <div class="form-group">
                                            ...
                                            <p>Template excel dapat diunduh <a href="<?php echo base_url('upload/template/template_supplier.xlsx');?>">disini</a>
                                        </div>
                                    </div>              
                                </div>                                   
                            </div>
