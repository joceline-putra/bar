<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="contact/category_contact"]').addClass('active');
        // console.log(view);  
        // $("select").select2();
        $(".date").datepicker({
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                {"targets": 0, "title": "Nama Group", "searchable": true, "orderable": false},
                {"targets": 1, "title": "URL", "searchable": true, "orderable": false},
                {"targets": 2, "title": "Jumlah Kontak", "searchable": true, "orderable": false},
