<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="contact/insurance"]').addClass('active');
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                ...
                {"targets": 1, "title": "Asuransi", "searchable": true, "orderable": true},
                ...
                success: function (d) {
                    if (parseInt(d.status) == 1) { /* Success Message */
                        ...
                        if (parseInt(d.result.contact_image) == 0) {
                            ...
                            $('#img-preview').attr('src', d.result.contact_image);
                        }
        ...
        $(document).on("click", "#btn-update", function (e) {
            ...
            var type_insurance = ($("#checkbox_insurance").is(':checked') == true) ? 1 : 0;
