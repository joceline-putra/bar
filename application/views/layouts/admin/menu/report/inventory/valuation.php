                        ...
                        <div class="grid-body">
                            <div class="row">    
                                    ...
                                    <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-right">
                                        <div class="pull-right">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="#" class="btn-print-all" data-action="1" data-format="html" data-request="report_stock_valuation">
                                                        <i class="fas fa-file-pdf"></i>&nbsp;&nbsp;PDF
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="#" class="btn-print-all" data-action="2" data-format="xls" data-request="report_stock_valuation">
                                ...
                                <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="padding-top:8px;">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-xs-12 col-sm-12 form-group padding-remove-left">
                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                    ...
                                    <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12 form-group padding-remove-right">
                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                            ...
                                            <select id="filter_order" name="filter_order" class="form-control">
                                                ...
                                                <option value="6">Total Harga</option>                                                                                                                                                
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12 form-group">
