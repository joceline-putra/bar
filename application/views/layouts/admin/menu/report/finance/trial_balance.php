									...
									<div class="col-md-4 col-xs-12 col-sm-12 padding-remove-right pull-right">
										...
										<div class="col-lg-3 col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="margin-top:4px;">											
											...
											<ul class="dropdown-menu">
												<li>
													<a href="#" class="btn-print-all" data-action="1" data-format="html" data-request="report_finance_trial_balance">
														<i class="fas fa-file-pdf"></i>&nbsp;&nbsp;PDF
													</a>
												</li>
												<li class="">
													<a href="#" class="btn-print-all" data-action="2" data-format="xls" data-request="report_finance_trial_balance">
