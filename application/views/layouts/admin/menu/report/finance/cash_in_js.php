...
<script>
	$(document).ready(function() {   
		...
		$(".nav-tabs").find('li[data-name="report/finance/cash_in"]').addClass('active');   
		...
		var index = $("#table-data").DataTable({
			...
			"ajax": {
				...
				data: function(d) {
					...
					// d.search = {
						// value:$("#filter_type").find(':selected').val()
					// };               
			...
			"columnDefs": [
				...
				{"targets":2, "width":"20%", "title":"Disetor Ke","searchable":true,"orderable":true},
