									...
									<div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left pull-left">
										<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 padding-remove-left" style="margin-top:4px;">
											<select id="filter_type" name="filter_type" class="form-control" style="height:31px!important;border:0px!important;background-color:#ecf0f2;">
												<option value="0" selected>Semua Transaksi Masuk</option>
												<option value="2">Pembayaran Piutang</option>
												<option value="3">Terima Kas</option>
												<option value="5">Transfer Uang</option>
												<option value="7">Uang Muka Penjualan</option>
										...
										<div class="col-lg-1 col-md-1 col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="margin-top:4px;">											
											...
											<ul class="dropdown-menu">
												<li>
													<a href="#" class="btn-print-all" data-action="1" data-format="html" data-request="report_finance_cash_in">
														<i class="fas fa-file-pdf"></i>&nbsp;&nbsp;PDF
													</a>
												</li>
												<li class="">
													<a href="#" class="btn-print-all" data-action="2" data-format="xls" data-request="report_finance_cash_in">
