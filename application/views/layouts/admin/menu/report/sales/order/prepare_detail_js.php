...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="report/sales/prepare/detail"]').addClass('active');
        ...
        var index = $("#table-data").DataTable({
            ...
            "columnDefs": [
                ...
                {"targets": 6, "title": "Checked", "searchable": false, "orderable": false}
            ],
            // "order": [
            //   [0, 'asc']
            // ],
            "columns": [{
                    ...
                    render: function (data, meta, row) {
                        ...
                        dsp += '<a class="btn-print" data-id="' + row.order_id + '" data-session="' + row.order_session + '" style="cursor:pointer;">';
                    ...
                    render: function (data, meta, row) {
                        ...
                        if (parseInt(row.order_item_flag) == 1) {
                            dsp += 'Checked';
                        } else {
                            dsp += '-';
                        }
