...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="report/sales/sell/recap"]').addClass('active');
        ...
        $(document).on("change", "#filter_kontak, #filter_order, #filter_dir, #filter_sales", function (e) {
            index.ajax.reload();
        });
        ...
        $(document).on("click", ".btn-print-all", function () {
            ...
            var print_url = url_print + '/'
                    ...
                    + $("#start").val() + '/'
                    + $("#end").val() + '/'
                    + contact + "?format=" + format + "&order=" + order + "&dir=" + dir + "&sales=" + sales;
