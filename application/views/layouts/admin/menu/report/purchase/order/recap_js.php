...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="report/purchase/order/recap"]').addClass('active');
        ...
        var contact_alias = "<?php echo $supplier_alias; ?>";
        ...
        $(document).on("click", ".btn-print-pembelian", function (e) {
            ...
            window.open(url_print_pembelian + id, 'Print', 'width=700,height=485,left=' + x + ',top=' + y + '').print();
        });
        /*
         $('#table-data').on('page.dt', function () {
         var info = index.page.info();
