...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="report/purchase/buy/account_payable"]').addClass('active');
        ...
        var index = $("#table-data").DataTable({
            ...
            "ajax": {
                ...
                cache: 'false',
                data: function (d) {
                    d.action = 'load-report-purchase-buy-account-payable';
                    // d.tipe = 1;
            ...
            "columnDefs": [
                ...
                {"targets": 7, "title": "Sisa Hutang", "searchable": false, "orderable": false, "class": "text-right"}
            ],
            // "order": [
            //   [0, 'asc']
            // ],
