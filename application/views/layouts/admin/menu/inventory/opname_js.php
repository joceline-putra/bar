...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="inventory/stock_opname"]').addClass('active');
            ...
            templateResult: function (datas) { //When Select on Click
                ...
                if ($.isNumeric(datas.id) == true) {
                    ...
                    if (parseInt(location) > 0) {
                        ...
                        notif(0, 'Gudang Penempatan harus dipilih dahulu');
                    }
                } else {
                    // return '<i class="fas fa-plus '+datas.id.toLowerCase()+'"></i> '+datas.text;          
                }
                    ...
                    $.ajax({
                        ...
                        success: function (d) {
                            if (parseInt(d.status) === 1) { //Success
                                ...
                                $("#form-trans-item input[name='stok']").val(d.stock.product_qty);
                            } else { //No Data
                                notif(0, d.message);
                            }
                        },
