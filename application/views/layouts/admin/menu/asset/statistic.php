                                            ...
                                            <div class="col-md-3 col-xs-4 form-group">
                                                ...
                                                <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                    ...
                                                    <div class="btn-group"> 
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="<?php echo base_url('asset/buy/new'); ?>" class="btn-default">
                                                                    <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Pembelian Aset
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('asset/sell/new'); ?>" class="btn-default">
                                                                    <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Penjualan Aset
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="<?php echo base_url('asset/depreciation/new'); ?>" class="btn-default">
                                                                    <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Penyusutan Aset
                                                                </a>
                                                            </li>                            
                                                        </ul>
                                                    </div>
