    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="tab-content">
                            ...
                            <div class="grid-body">
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                        <div class="grid simple">
                                            <div class="grid-body">
                                                <h5><b><i class="fas fa-table"></i> Form <?php echo $title; ?>: Identity: <?php echo $identity; ?></b></h5>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                                                    ...
                                                                    <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-side">
                                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                                            <div class="form-group">
                                                                                <label class="form-label">Kepada Supplier *</label>
                                                                    ...
                                                                    <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-side">
                                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input id="nomor" name="nomor" type="text" value="" class="form-control"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-side">
                                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left">
                                                                            <div class="form-group">
                                                                                <label class="form-label">Nomor Ref Supplier</label>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                    <div class="grid simple">
                                        ...
                                        <div class="grid-body">
                                            <h5><b><i class="fas fa-table"></i> Daftar Item <?php echo $title; ?></b></h5>
                                            <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                                <form id="form-trans-item" name="form-trans-item" method="" action="">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                                        ...
                                                        <div class="col-md-7 col-xs-12 col-sm-12 padding-remove-side">
                                                            ...
                                                            <div class="col-md-5 col-xs-12 col-sm-12 padding-remove-left">
                                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side scroll">
                                                <table id="table-item" class="table table-striped" data-limit-start="0" data-limit-end="10">
                                                    <thead>
                                                        <tr>
                                                            <th>Produk / Jasa</th>
            ...
            <div class="tab-pane" id="tab2">
                <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                    <div class="grid simple col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                        <div class="grid-body ">
                            ...
                            <div class="col-md-6 col-xs-4 form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <div class="tiles green m-b-10">
                        <div class="tiles-body">
                          ...
                          <div class="tiles-title text-white">TOTAL DOKUMEN <?php echo strtoupper($title); ?> BULAN INI</div>
                          <h3 class="text-white semi-bold">$15,354</h3>                
                          <div class="description">
                            <span class="text-white mini-description ">
                              <span class="blend">20% lebih tinggi dari bulan lalu</span>
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <div class="tiles gray m-b-10">
                        <div class="tiles-body">
                          ...
                          <div class="tiles-title text-white">TRANSAKSI <?php echo strtoupper($title); ?> TERAKHIR</div>
                          <h3 class="text-white semi-bold">SOP-2005-001</h3>                
                          <div class="description">
                            <span class="text-white mini-description ">
                              <span class="blend">23 jam yang lalu</span>
                            </span>
                          </div>
                        </div>
                      </div>
...
<div class="modal fade" id="modal-order-item-edit" role="dialog" style="" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #05534d;">
                <h4 id="modal-order-item-edit-title" style="color:white;">Tambahkan Produk Tambahan</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
