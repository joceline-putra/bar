...
if ($session['user_data']['user_id'] == 0) {
    ...
    <div class="row">
            ...
            <div class="grid simple">
                <div class="grid-body">
                    <div class="col-md-12 col-sm-12 padding-remove-side">
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 padding-remove-left">
                            <label class="form-label">Periode</label>
                            <div id="dashboard_date" 
                                data-start="<?php echo $end_date; ?>" 
                                data-end="<?php echo $end_date; ?>" 
                                class="filter-daterangepicker" 
                                style="padding-top:4px;padding-bottom:4px;height:29px;">
                                <i class="fas fa-calendar-alt"></i>&nbsp;
                                    <span></span> 
                                    &nbsp;&nbsp;&nbsp;
                                    <i class="fas fa-caret-down" style="position: absolute;right: 24px;top: 28px;">
                                </i>
                            </div>
                        </div>									
                        <div class="col-md-4 col-sm-12 col-xs-12 padding-remove-left">
                            <div class="form-group">
                                <label class="form-label" style="font-size: 12px;">Cabang</label>
                                <select name="dashboard_branch" id="dashboard_branch" style="width:100%;border-radius:4px;height:29px!important;border:1px solid #a2a4a6;">
                                    <option value="0">Semua Cabang</option>                                                 
                                    <?php
                                    foreach ($branchnya as $i => $v) {
                                        echo "<option value=" . $v['branch_id'] . ">" . ucwords(strtolower($v['branch_name'])) . "</option>";
                                    }
                                    ?>                       
                                </select>
                            </div>
                        </div>	
                        <div class="col-lg-2 col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="">	
                            <div class="form-group">
                                <label class="form-label" style="font-size: 12px;">Action</label>										
                                <a class="btn btn-success btn-small dropdown-toggle" style="width:100%;" data-toggle="dropdown" href="#" aria-expanded="true"> 
                                    <i class="fas fa-print"></i>&nbsp;&nbsp;Print&nbsp;&nbsp;<span class="fas fa-caret-down"></span> 
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="#" class="btn-print-all" data-action="1" data-format="html" data-request="report_finance_journal">
                                            <i class="fas fa-file-pdf"></i>&nbsp;&nbsp;PDF
                                        </a>
                                    </li>
                                    <li class="">
                                        <a href="#" class="btn-print-all" data-action="2" data-format="xls" data-request="report_finance_journal">
        ...
        <div class="hide col-lg-12 col-md-12 col-xs-12 col-sm-12 padding-remove-side">
        ...
        <div class="hide col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-top:10px;">
            ...
            <div class="col-lg-5 col-md-12 col-xs-12 padding-remove-side">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 padding-remove-right">
                    <div id="top_expense" class="col-md-12 col-sm-12 col-xs-12 padding-remove-side" style="display:none;">
                        <div class="grid simple">   
                            <div class="grid-body no-border" style="padding:10px;">                   
                                <!-- <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side"> -->
                                <div class="col-md-12 col-sm-12 padding-remove-side">          
                                ...
                                <table class="table no-more-tables m-t-20 m-b-30">
                                    <thead>
                                        <tr>
                                            <th>Biaya</th>
                                            <th style="text-align:right;">Nilai Saat ini</th>
                    ...
                    <div id="top_account" class="col-md-12 col-sm-12 col-xs-12 padding-remove-side" style="display:none;">
                        <div class="grid simple">
                            <div class="grid-body no-border" style="padding:10px;">                   
                                <!-- <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side"> -->
                                <div class="col-md-12 col-sm-12 padding-remove-side">          
                    ...
                    <div id="top_customer" class="col-md-12 col-sm-12 col-xs-12 padding-remove-side" style="display:none;">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h5>5 Top Pembayaran Customer</h5>
                                <!-- <div class="tools">
                                    <a href="javascript:;" class="collapse"></a>
                                    <a onclick="" href="javascript:;" class="reload"></a>
                                    <a href="javascript:;" class="remove"></a>
                            ...
                            <div class="grid-body no-border" style="padding:10px;">                   
                                ...
                                <!-- </div> -->
                                <table id="table-top-customer" class="table no-more-tables">
                                    <thead>
                                        <tr>
                                            <td>Customer</td>
                        ...
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                ...
                                <!-- <div class="tools">
                                    <a href="javascript:;" class="collapse"></a> -->
                                    <!-- <a href="#grid-config" data-toggle="modal" class="config"></a> -->
                                    <!-- <a onclick="top_trans_overdue(1);" href="javascript:;" class="reload"></a>
                                    <a href="javascript:;" class="remove"></a>
                                </div> -->
                            </div>      
                            <div class="grid-body no-border" style="padding:10px;">                   
                    ...
                    <div id="top_sell_overdue" class="col-md-12 col-sm-12 col-xs-12 padding-remove-side" style="display:none;">
                        <div class="grid simple">
                            <div class="grid-title no-border">
                                <h5>Piutang Sampai Hari Ini</h5>
                                <!-- <div class="tools"> -->
                                    <!-- <a href="javascript:;" class="collapse"></a> -->
                                    <!-- <a href="#grid-config" data-toggle="modal" class="config"></a> -->
                                    <!-- <a onclick="top_trans_overdue(2);" href="javascript:;" class="reload"></a> -->
                                    <!-- <a href="javascript:;" class="remove"></a> -->
                                <!-- </div> -->
                            </div>      
                            <div class="grid-body no-border" style="padding:10px;">                   
