                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                                    <form id="form-master" name="form-master" method="" action="">    
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">              
                                            <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side" style="padding-bottom:10px;">
                                                <div class="form-group">
                                                    <label>Preview</label>
                                                    <span id="label_preview" class="label">
                                                        <i id="label_icon" class=""></i>
                                                        <span id="label_text">Preview</span>
                                                    </span>
                                                </div>
                                            </div>     
                                            <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">                                     
                                                <div class="col-lg-6 col-md-6 col-xs-6 padding-remove-left">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="ref_name" name="ref_name" type="text" value="" class="form-control" readonly='true'/>
                                                    </div>
                                                </div> 
                                                <div class="col-lg-6 col-md-6 col-xs-6 padding-remove-right">
                                                    <div class="form-group">
                                                        <label>Icon</label>
                                                        <input id="ref_note" name="ref_note" type="text" value="" class="form-control" readonly='true'/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
                                                <div class="col-lg-6 col-md-6 col-xs-6 padding-remove-left">
                                                    <div class="form-group">
                                                        <label>Warna Huruf</label>
                                                        <input id="ref_color" name="ref_color" type="text" value="" class="form-control" readonly='true'/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-xs-6 padding-remove-right">
                                                    <div class="form-group">
                                                        <label>Warna Background</label>
                                                        <input id="ref_background" name="ref_background" type="text" value="" class="form-control" readonly='true'/>
                                                    </div>
                                                </div>                                                       
                                            </div>          
                                            <div class="col-lg-12 col-md-12 col-xs-12 padding-remove-side">
