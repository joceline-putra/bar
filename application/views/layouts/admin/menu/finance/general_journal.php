                                                ...
                                                <div class="col-md-12 col-xs-12 col-sm-12" style="padding-left: 0;
                                                    ...
                                                    <form id="form-trans-item" name="form-trans-item" method="" action="">
                                                        ...
                                                        <div class="col-md-8 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            <div class="col-md-4 col-xs-12 col-sm-12 prs-0">
                                                                <div class="form-group">
                                                                    <label class="form-label">Keterangan</label>
                                                                    <input id="account_debit_note" name="account_debit_note" type="text" value="" class="form-control"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3 col-xs-6 col-sm-12 padding-remove-left prs-0 prr-2">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-3 col-xs-6 col-sm-12 padding-remove-left">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="account_credit_total" name="account_credit_total" type="text" value="" class="form-control"/>
                                                                </div>
                                                            </div>                              
                                                    ...
                                                    <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    <label class="form-label col-md-12 prs-0">Total Rincian Item</label>
                                                                    <div class="col-md-12 prs-0">
                                                                        <input id="total_item" name="total_item" type="text" value="0" class="form-control" style="text-align:right;" readonly='true'/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    <label class="form-label col-md-12 prs-0">Total Debit</label>
                                                                    <div class="col-md-12 prs-0">
                                                            ...
                                                            <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    <label class="form-label col-md-12 prs-0">Total Kredit</label>
                                                                    <div class="col-md-12 prs-0">
