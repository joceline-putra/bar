<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="finance/general_journal"]').addClass('active');
        ...
        $(document).on("click", "#btn-save-item", function (e) { // save journal_detail    
            ...
            if($("#account_debit_total").val().length == $("#account_credit_total").val().length){
                next=false;
                notif(0,'Debit / Kredit belum diisi');
            }
