                                                    ...
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                        ...
                                                        <div class="btn-group"> 
                                                            ...
                                                            <ul class="dropdown-menu dropdown-statistic">
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/cash_out/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Kirim Uang
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/cash_in/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Terima Uang
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/bank_statement/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Transfer Uang
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/cash_out/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Biaya
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/general_journal/new'); ?>" class="btn-default">
                                        ...
                                        <div class="col-md-4 col-xs-12 col-sm-12" style="padding-left: 0;">               
                                            <div class="grid simple">
                                                <div class="grid-body">                   
                                                    <div class="row">
                                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                                            <h5><b><i class="fas fa-file-alt fa-2x"></i> Saldo Kas & Bank</b></h5>      
                                        ...
                                        <div class="col-md-4 col-xs-12 col-sm-12" style="padding-left: 0;">                      
                                            <div class="grid simple">
                                                <div class="grid-body">                   
                                                    <div class="row">
                                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                                            <h5><b><i class="fas fa-calendar-minus fa-2x"></i> Pemasukan</b></h5>
                                        ...
                                        <div class="col-md-4 col-xs-12 col-sm-12" style="padding-left: 0;">
                                            <div class="grid simple">
                                                <div class="grid-body">                   
                                                    <div class="row">
                                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                                            <h5><b><i class="fas fa-money-bill fa-2x"></i> Pengeluaran</b></h5>                              
