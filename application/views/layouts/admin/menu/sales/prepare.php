                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                                <form id="form-trans-item" name="form-trans-item" method="" action="">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                                        ...
                                                        <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            <div class="col-md-3 col-xs-5 col-sm-5 prs-0 prr-2">
                                                                <div class="form-group">
                                                                    <label>Satuan</label>
                                                            ...
                                                            <div class="col-md-3 col-xs-7  col-sm-7 padding-remove-left">
                                                                <div class="form-group">
                                                                    <label>Qty</label>
                                                            ...
                                                            <div class="col-md-4 col-xs-12 col-sm-12 padding-remove-left">
                                                              <div class="form-group">
                                                                ...
                                                                <input id="harga" name="harga" type="text" value="0.00" class="form-control"
                                                                  readonly='true' />
                                                              </div>
                                                            </div>
                                                            <div class="col-md-2 col-xs-12 col-sm-12 padding-remove-left">
                                                              <div class="form-group">
                                                                <label>Qty Kg</label>
                                                                <input id="qty_kg" name="qty_kg" type="text" value="0.00" class="form-control" readonly='true'/>
                                                              </div>
                                                            </div> 
                                                            -->                             
                                                            <div class="col-md-2 col-xs-12 col-sm-12 padding-remove-left">
