                                                    ...
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                        ...
                                                        <div class="btn-group"> 
                                                            ...
                                                            <ul class="dropdown-menu dropdown-statistic" style="">
                                                                <li>
                                                                    <a href="<?php echo base_url('purchase/quotation/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Penawaran Pembelian
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('purchase/order/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Pesanan Pembelian
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('purchase/buy/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Penagihan Pembelian
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('purchase/return/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Retur Pembelian
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('finance/accout_payable/new'); ?>" class="btn-default">
                                                                        <i class="fas fa-file-alt"></i>&nbsp;&nbsp;Pembayaran Hutang
                                                                    </a>
                                                                </li>                              
                                                            </ul>
                                                        </div>
