<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="purchase/return"]').addClass('active');
                        ...
                        if (parseInt(d.status) === 1) { //Success
                            ...
                            if (parseInt(total_records) > 0) {
                                ...
                                for (var a = 0; a < total_records; a++) {
                                    ...
                                    dsp += '    data-trans-item-qty="' + d.result[a]['trans_item_out_qty'] + '"';
                                    dsp += '    data-trans-item-price="' + d.result[a]['trans_item_out_price'] + '"';
                                    ...
                                    dsp += '    value="' + d.result[a]['trans_item_out_qty'] + '" readonly';
                                    dsp += '    >';
                                    dsp += '  </td>';
                                    ...
                                    // dsp += '    <!-- <a class="btn-modal-riwayat-pembayaran" href="#" data-trans-item-id="<?php #echo $v['trans_item_id'];  ?>">Rp. 1,000.00</a> -->';
                                                                        dsp += '    ' + d.result[a]['trans_item_out_price'] + '';
                                                                        dsp += '  </td>';
