                                        ...
                                        <form id="form-trans" name="form-trans-item" method="" action="">
                                            ...
                                            <div class="col-md-3 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label" style="padding-bottom: 4px;">Diambil dari Pembelian</label><br>
                                            ...
                                            <div class="col-md-5 col-xs-12 col-sm-12">
                                                <div class="col-md-6 col-xs-12 form-group prl-5 prs-0">
                                                ...
                                                <div class="col-md-6 col-xs-12 col-sm-12 prr-5 prs-0">
                                                                        ...
                                                                        <tbody id="table-item-tbody">
                                                                            <?php foreach ($retur_data as $v) { ?>
                                                                                <tr class="tr-trans-item-id" data-trans-item-id="<?php echo $v['trans_item_id']; ?>">
                                                                                    ...
                                                                                    <td style="text-align:right;"><?php echo $v['trans_item_in_qty']; ?></td>
                                                                                    ...
                                                                                    <td style="text-align:right;">
                                                                                        <input name="form-trans-item-input" type="text" class="form-control form-trans-item-input"
                                                                                            ...
                                                                                            data-trans-item-qty="<?php echo $v['trans_item_in_qty']; ?>"
                                                                                            data-trans-item-price="<?php echo $v['trans_item_in_price']; ?>"
                                                                                    ...
                                                                                    <!-- <a class="btn-modal-riwayat-pembayaran" href="#" data-trans-item-id="<?php echo $v['trans_item_id']; ?>">Rp. 1,000.00</a> -->
                                                                                        <?php echo number_format($v['trans_item_in_price'], 2, '.', ','); ?>
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php
                                                                                        $ppn = "Non Ppn";
                                                        ...
                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            ...
                                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input id="total_dpp" name="total_dpp" type="text" value="0" class="form-control" style="text-align:right;" readonly='true' />
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
