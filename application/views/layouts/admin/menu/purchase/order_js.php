...
<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="purchase/order"]').addClass('active');

        //Url
        var url = "<?= base_url('order/manage'); ?>";
        var url_buy = "<?= base_url('purchase/buy'); ?>";
        ...
        var index = $("#table-data").DataTable({
            ...
            "columns": [{
                    ...
                    render: function (data, meta, row) {
                        var dsp = '';
                        dsp += '<a class="btn-contact-info" data-id="' + row.order_contact_id + '" data-type="order" style="cursor:pointer;" data-contact-type="'+row.contact_type+'">';
