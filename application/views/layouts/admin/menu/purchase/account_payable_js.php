<script>
    $(document).ready(function () {
        ...
        $(".nav-tabs").find('li[data-name="finance/account_payable"]').addClass('active');
        ...
        new AutoNumeric('#total', autoNumericOption);
        ...
        $(document).on("click", ".btn-modal-transaksi", function (e) {
            ...
            var url_print = url_print_buy + '/' + ss;
                        ...
                        if (parseInt(d.status) === 1) { //Success
                            ...
                            if (parseInt(total_records) > 0) {
                                ...
                                for (var a = 0; a < total_records; a++) {
                                    ...
                                    dsp += '<td><a class="btn-modal-transaksi" href="#" data-id="' + d.result[a]['trans_id'] + '" data-session="' + d.result[a]['trans_session'] + '"><i class="fas fa-file-alt"></i> ' + d.result[a]['trans_number'] + '</a><br>&nbsp;' + d.result[a]['contact_name'] + '</td>';
                                    dsp += '<td style="text-align:left;">' + trans_note + '</td>';
                                    dsp += '<td style="text-align:left;">' + d.result[a]['trans_date_due_format'] + '</td>';
                                    dsp += '<td style="text-align:right;"><a class="btn-trans-item-info" href="#" data-id="' + d.result[a]['trans_id'] + '" data-contact-name="' + d.result[a]['contact_name'] + '" data-trans-type="1" data-trans-number="' + d.result[a]['trans_number'] + '">Rp. ' + d.result[a]['trans_total'] + '</a></td>';
                                    dsp += '<td style="text-align:right;"><a class="btn-trans-payment-info" href="#" data-id="' + d.result[a]['trans_id'] + '" data-contact-name="' + d.result[a]['contact_name'] + '" data-trans-type="1" data-trans-number="' + d.result[a]['trans_number'] + '" data-trans-total="' + d.result[a]['trans_total'] + '">Rp. ' + addCommas(d.result[a]['total_sisa']) + '</a></td>';
                                    dsp += '<td>';
                                    dsp += '<input ' +
                                    ...
                                    // dsp += '</button>';
                                    // dsp += '<button type="button" class="btn-edit-item btn btn-mini btn-primary" data-journal-id="'+d.result[a]['journal_item_journal_id']+'" data-journal-item-id="'+d.result[a]['journal_item_id']+'" data-journal-item-account-id="'+d.result[a]['account_id']+'" data-nama="'+d.result[a]['account_name']+'" data-kode="'+d.result[a]['account_code']+'" data-journal-item-debit="'+d.result[a]['journal_item_debit']+'" data-journal-item-credit="'+d.result[a]['journal_item_credit']+'" data-journal-item-note="'+d.result[a]['journal_item_note']+'">';
                                    // dsp += '<span class="fas fa-plus"></span> Tambah Keterangan';
                                    // dsp += '</button>';                       
                                    dsp += '</td>';
                                    dsp += '</tr>';
                        ...
                        if (parseInt(d.status) === 1) { //Success
                            ...
                            if (parseInt(total_records) > 0) {
                                ...
                                for (var a = 0; a < total_records; a++) {
                                    ...
                                    var i = a;
                                    dsp += '<tr class="tr-trans-item-id" data-id="' + d.result[a]['trans_id'] + '">';
                                    dsp += '<td><a class="btn-modal-transaksi" href="#" data-id="' + d.result[a]['trans_id'] + '" data-session="' + d.result[a]['trans_session'] + '"><i class="fas fa-file-alt"></i> ' + d.result[a]['trans_number'] + '</a><br>&nbsp;' + d.contact.contact_name + '</td>';
                                    dsp += '<td style="text-align:left;">' + trans_note + '</td>';
                                    ...
                                    dsp += '<td style="text-align:right;"><a class="btn-trans-item-info" href="#" data-id="' + d.result[a]['trans_id'] + '" data-contact-name="' + d.contact.contact_name + '" data-trans-type="1" data-trans-number="' + d.result[a]['trans_number'] + '">Rp. ' + d.result[a]['trans_total'] + '</a></td>';
                                    dsp += '<td style="text-align:right;"><a class="btn-trans-payment-info" href="#" data-id="' + d.result[a]['trans_id'] + '" data-contact-name="' + d.contact.contact_name + '" data-trans-type="1" data-trans-number="' + d.result[a]['trans_number'] + '" data-trans-total="' + d.result[a]['trans_total'] + '">Rp. ' + addCommas(d.result[a]['total_sisa']) + '</a></td>';
