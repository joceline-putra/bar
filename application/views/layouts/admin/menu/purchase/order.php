                                                ...
                                                <form id="form-trans-item" name="form-trans-item" method="" action="">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                                        ...
                                                        <div class="col-md-7 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            ...
                                                            <div class="col-md-3 col-xs-3 col-sm-12 padding-remove-left prs-0 prr-2">
                                                                <div class="form-group">
                                                                    <label class="form-label">Qty</label>
                                                                    <input id="qty" name="qty" type="text" value="1" class="form-control" readonly='true' />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-5 col-xs-9 col-sm-12 padding-remove-left prs-0 prl-2">
                                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                ...
                                                <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                    ...
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                        ...
                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                            <div class="form-group">
                                                                <label class="col-md-5 prs-0 form-label">Dengan Down Payment ?</label>
                                                                <div class="col-md-7 prs-0">
                                                                    <select id="order_with_dp_type" name="order_with_dp_type" class="form-control">
                                                        ...
                                                        -->
                                                        <div id="div_order_with_dp" style="display: none;" class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    <label class="col-md-5 prs-0 form-label">Masukkan Jumlah DP</label>
                                                                    <div class="col-md-7 prs-0">
                                                                        <input id="order_with_dp" name="order_with_dp" type="text" value="0" class="form-control" style="text-align:right;"/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                                <div class="form-group">
                                                                    <label class="col-md-5 prs-0 form-label">DP Menggunakan</label>
                                                                    <div class="col-md-7 prs-0">
                                                                        <select id="order_with_dp_account" name="order_with_dp_account" class="form-control">
