                                                        ...
                                                        <form id="form-trans" name="form-trans" method="" action="">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 prs-0">
                                                                ...
                                                                <div class="col-md-4 col-sm-12 col-xs-12 prs-5">
                                                                    ...
                                                                    <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-left prs-5">
                                                                        <div class="col-md-12 col-xs-12 form-group prs-0">
                                                                            <label class="form-label">Tgl Tempo Pembayaran</label>
                                                                            <div class="col-md-12 col-sm-12 padding-remove-side">
                                                                    ...
                                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left prs-5">
                                                                        <div class="col-md-12 col-xs-12 col-sm-12 form-group prs-0">
                                                                            <div class="form-group prs-5">
                                                                                <label class="form-label">Penempatan Stok</label>
                                                                ...
                                                                <div class="col-md-4 col-sm-12 col-xs-12 padding-remove-right prs-5">
                                                                    ...
                                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-5">
                                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left prs-5">
                                                                            <div class="form-group">
                                                                                <label class="form-label">Nomor Referensi Supplier</label>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                    <div class="grid simple">
                                        ...
                                        <div class="grid-body">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0 prs-2">
                                                <form id="form-trans-item" name="form-trans-item" method="" action="">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side prs-0">
                                                        ...
                                                        <div class="col-md-8 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                            <div class="col-md-2 col-xs-12 col-sm-12 prs-0">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-2 col-xs-4 col-sm-12 padding-remove-left prs-0 prr-2">
                                                                <div class="form-group">
                                                                    <label class="form-label">Qty</label>
                                                                    <input id="qty" name="qty" type="text" value="1" class="form-control" readonly='true' />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2 col-xs-8 col-sm-12 padding-remove-left">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-2 col-xs-8 col-sm-12 padding-remove-left prs-0 prr-2">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-2 col-xs-4 col-sm-12 padding-remove-left prs-0">
                                                                <div class="form-group">
                                                                    <label class="form-label">Qty Coli</label>
                                                ...
                                                <table id="table-item" class="table table-bordered" data-limit-start="0" data-limit-end="10">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align:right;">Lokasi Penempatan</th>                              
                                                            <th style="text-align:left;">Ppn</th>                  
                                                            <th style="text-align:right;">Qty Coli</th>                                                                                          
                                            ...
                                            <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                        <div class="form-group">
                                                            <label class="col-md-5 padding-remove-side prs-0 form-label">Total Produk</label>
                                                ...
                                                <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                    ...
                                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0">
                                                        ...
                                                        <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side prs-0" style="margin-bottom:4px;">
                                                            <div class="form-group">
                                                                <label class="col-md-5 prs-0 form-label">Ppn</label>
                                                                <div class="col-md-7 prs-0">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li class="">
                                                                    <a href="#" class="btn-print-dropdown" data-action="print_history">
                                                                        <i class="fas fa-print"></i>&nbsp;&nbsp;Faktur + Riwayat
                                                                    </a>
                                                                </li>
                                                                <li class="">
                                    ...
                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                        ...
                                        <div class="col-md-2 col-xs-12 col-sm-12 padding-remove-left">
                                            <div class="form-group">
                                                ...
                                                <input id="e_pack" name="e_pack" type="text" value="1" class="form-control" readonly='true'/>
                                            </div>                            
                                        </div>                                                       
                                        <div class="col-md-3 col-xs-12 col-sm-12 padding-remove-left">
                                            <div class="form-group">
